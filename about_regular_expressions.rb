...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # if there a character after the asterix that wasn't in the setup
    # e.g "abbcccddddeeeee"[/z*f/] returns nil
  end
  ...
  # the repitition operators will return all occurences of the characters that match the regular expression.
  ...
  # character class you are looking for one of three cases, whereas in alternation, you have to check each one individually.
