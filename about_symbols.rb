...
class AboutSymbols < Neo::Koan
  ...
  def test_symbols_are_not_strings
    ...
    assert_equal false, symbol.eql?("ruby") # :ruby and "ruby" do not belong to the same hash key
  end

  def test_symbols_do_not_have_string_methods
    symbol = :not_a_string
    assert_equal false, symbol.respond_to?(:each_char) # .respond_to checks whether the given object responds to the specified method.
