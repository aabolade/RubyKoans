...
It was the worst of times.
    ...
    assert_equal "\n", long_string[0,1] #the 0th index of the string is a new line
  end
...
EOS
  ...
  def test_strings_can_be_split_with_different_patterns
    ...
    words = string.split(/:/) #string will split array every where it sees ":"
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, a           == b
    assert_equal false, a.object_id == b.object_id  #two strings may have the same text but their object_id will be unique
  end
end
